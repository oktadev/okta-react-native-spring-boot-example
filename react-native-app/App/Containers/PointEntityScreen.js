...
// Styles
import styles from './Styles/PointEntityScreenStyle'
...
class PointEntityScreen extends React.PureComponent {
  static onEnter () {
    NavigationActions.refresh({
      rightTitle: 'Create',
      onRight: () => {
        NavigationActions.pointEntityEdit({ entityId: null })
      }
    })
  }
  ...
  *************************************************************/
  renderRow ({item}) {
    return (
      <TouchableOpacity onPress={NavigationActions.pointEntityDetail.bind(this, { entityId: item.id })}>
